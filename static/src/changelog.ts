export const APP_VERSION = '1.2.43.0'
...
export const changelog: ChangelogEntry[] = [
  {
    ...
    date: '2026-08-27',
    changeKeys: [
      'deviceUrlOfflineEditFix',
      'footerTextLeftClipFix',
    ],
  },
  {
    version: '1.2.42.0',
