...
urlpatterns = [
    ...
    path('mfa/email/status/', views.email_otp_status),
    path('mfa/email/enroll/', views.email_otp_enroll),
    path('mfa/email/confirm/', views.email_otp_confirm),
    path('mfa/email/disable/', views.email_otp_disable),
